...
public:
     ...
     * @param T : Terrain auquel correspond la carte.
     ...
     * À chaque itération, le déplacement de l'eau est calculé pour chaque point du terrain, jusqu'à aboutir à l'emplacement final des cours d'eau.
     */
